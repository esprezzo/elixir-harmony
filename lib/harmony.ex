defmodule Harmony do
  @moduledoc """
  This library presents a convenient interface to control a full Harmony node from Elixir, 
  ...
  alias Harmony.Eth
  alias Harmony.Net
  alias Harmony.Personal
  alias Harmony.Aggregates
  alias Harmony.HexUtils
  alias Harmony.ABI
  alias Harmony.TxPool
  ...
  defdelegate get_logs(map), to: Eth
