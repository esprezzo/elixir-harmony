defmodule Harmony.Personal do
  @moduledoc """
    Personal namespace for Harmony JSON-RPC
  ...
  @doc """
  Create new account to be managed by connected Harmony node with password/password confirmation

  ## Example: 

      iex> Harmony.new_account("p@55w0rd","p@55w0rd")
  ...
  @doc """
  Unlock account account on conected Harmony node
  ...
  @doc """
  Lock account account on conected Harmony node
  ...
  ## Example:
      ...
      ...> amount = 0.5
      ...> password = ""
      ...> Enum.each(1..1000, fn x -> Harmony.send_transaction(sender, receiver, amount, password) end)
      ...> - OR -
      ...> Harmony.send_transaction(sender, receiver, amount, password)
