defmodule Harmony.Eth do
  @moduledoc """
  Eth Namespace for Harmony JSON-RPC
  RPC calls
  """
  alias Harmony.Transport
  alias Harmony.Conversion
  require IEx
  require Logger
  ...
  @doc """
  Get balance of Harmony account by hash

  ## Example:

      Harmony.get_balance("0xfE8bf4ca8A6170E759E89EDB5cc9adec3e33493f")
  ...
  ## Example:
      ...
      iex> Harmony.get_block_by_number(43, false)
  ...
  ## Example: 
      ...
      iex> Harmony.get_block_by_hash("0xb8bbe729e16b9aa1b30c157c7d799ddb68814ae183cf6a1c9d3597916e54f50f")
      {:ok, 
        %{
  ...
  @doc """  
  Get current sync status of Harmony node
  ...
  @doc """
  Get coinbase address for Harmony node
  ...
  @doc """
  Get current mining status for Harmony node
  ...
  @doc """
  Get current hashrate of Harmony network
  ...
  ## Example:
      ...
      iex> Harmony.get_transaction_by_hash("0xbbdea9b303ba7b605130ce0c2dd261893a086f7221511d7a31964c4aab70dca3")
      {:ok, 3858216}
...
@doc """
  ...
  ## Example:
      ...
      iex> Harmony.uninstall_filter("0x")
      {:ok, _}
...
@doc """
  ...
  ## Example:
      iex> Harmony.get_transaction_receipt_by_hash("0x6911ae06acd22106a21762af4ce3a8c93156358b6679ccc905ebfab1c34c6e63")
      %{
