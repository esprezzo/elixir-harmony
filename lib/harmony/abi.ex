defmodule Harmony.ABI do
  ...
  @doc "Encodes data into Harmony hex string based on types signature"
  ...
  @doc "Encodes options into Harmony JSON RPC hex string"
  ...
  def keys_to_decimal(map, keys) do
    for k <- keys, into: %{}, do: {k, map |> Map.get(k) |> Harmony.hex_to_decimal()}
  end
